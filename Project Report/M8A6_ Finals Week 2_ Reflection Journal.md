...
main.dart still had Flutter's default boilerplate code instead of pointing to my actual app. Every time I ran flutter run -d chrome, it showed the default template instead of my project, and I had to work out that the entry point hadn't been wired up yet.
